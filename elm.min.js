...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aG, request.aV, true);
		} catch (e) {
...
var $author$project$Main$PostedEntry = function (a) {
	return {$: 3, a: a};
};
var $author$project$Main$Success = 2;
var $author$project$Main$baseUrl = 'https://fv5c7jlkul.execute-api.us-east-1.amazonaws.com';
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{at: false, av: r.av, aA: r.aA, T: r.T, aG: r.aG, aR: r.aR, an: r.an, aV: r.aV}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{av: r.av, aA: r.aA, T: _List_Nil, aG: 'POST', aR: $elm$core$Maybe$Nothing, an: $elm$core$Maybe$Nothing, aV: r.aV});
};
		...
		switch (msg.$) {
			...
			case 4:
				...
				return _Utils_Tuple2(
					...
					$elm$http$Http$post(
						{
							av: $elm$http$Http$jsonBody(body),
							aA: $elm$http$Http$expectWhatever($author$project$Main$PostedEntry),
							aV: $author$project$Main$baseUrl + '/entries'
						}));
			default:
				if (!msg.a.$) {
...
var $author$project$Main$NewJournalId = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$SubmittedEntry = {$: 2};
	...
	switch (status) {
		...
		default:
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Nothing to report.')
					]));
	}
};
	...
	return A2(
		...
		_List_fromArray(
			[
					...
					[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onInput($author$project$Main$NewJournalId)
									]),
								_List_Nil)
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Events$onInput($author$project$Main$NewContent)
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onClick($author$project$Main$SubmittedEntry)
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$author$project$Main$viewStatus(model.y)
					]))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{aE: $author$project$Main$init, aQ: $author$project$Main$subscriptions, aU: $author$project$Main$update, aW: $author$project$Main$view});
